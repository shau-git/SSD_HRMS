...
const commonRulesEdit = {
  ...
  editAttendance: {
    ...
    edit_status : Joi.string().valid('PENDING', 'APPROVED', 'REJECTED')
        .messages({
            'any.only': "Edit status must be one of: 'PENDING', 'APPROVED', 'REJECTED' "
        }),
    ot_req_status : Joi.string().valid('PENDING', 'APPROVED', 'REJECTED')
        .messages({
            'any.only': "OT request status must be one of: 'PENDING', 'APPROVED', 'REJECTED' "
        }),
  }
...
const operationRules = {
  ...
  // PUT req for Employer (edit attendance)
  editAttendance_E:{
    ...
    // is_ammended is optional here, use for approve or reject
  ...
  editAttendance_E_A: {
    ...
    //is_ot is optional here

    hours_of_ot: commonRulesEdit.editAttendance.hours_of_ot, // depend on ot

    // is_ammended is optional here

    edit_status: commonRulesEdit.editAttendance.edit_status, //optional

    // remarks is optional here

    // manager_id is optional here
